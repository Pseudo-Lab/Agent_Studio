...
규칙:
- step_decision 필드에 "repeat", "advance", "abort" 중 하나를 반드시 포함하세요.
- 현재 단계가 완료되었다고 판단되면 step_decision="advance"로 설정하세요.
- 아직 진행 중이거나 사용자에게 질문이 필요하면 step_decision="repeat"로 설정하세요.
- 사용자가 종료/취소 의사를 명확히 표현하면 step_decision="abort"로 설정하세요.
